...
opts.mtzREFMAC =   'import/lys_2_lys_5_refmac.mtz';
opts.mtzMerged =   'import/lys_2_lys_5_Imerge.mtz';
opts.pdbFileName = 'import/lys_2_lys_5_refmac.pdb';

opts.refmac_filter = struct('H','h','K','k','L','l','FREER','isFree','FP','Fobs','SIGFP','sigmaFobs',...
    'FC_ALL_LS','Fcalc','PHIC_ALL_LS','phiFcalc');

opts.merged_filter = struct('H','h','K','k','L','l','Iplus','Imerge','SIGIplus','sigmaImerge');
...
x = 0.0001; % determined previously by fitting Fobs vs. Fcalc
