...
MT = proc.script.MapTools.import(h5In,'total');
...
[I,sigma] = MT.read_data(h5In,'total','I','sigma');
[To] = MI.sgolay_filter_at_target(I,sigma,To,1/150);

[I,sigma] = MT.read_data(h5In,'total','I1','sigma1');
[To1] = MI.sgolay_filter_at_target(I,sigma,To,1/150);

[I,sigma] = MT.read_data(h5In,'total','I2','sigma2');
...
MT.export(h5In,'variational',I,sigma,'newmap',true,'Datatype','single','ChunkSize',ndiv);
