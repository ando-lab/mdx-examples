...
mapFileIn = '../lys_tri_map/export/lys_tri_delta_pdf.h5';
MTp = proc.script.MapTools.import(mapFileIn,'delta_pdf');

% load goodvibes simulation
[MT,I] = proc.script.MapTools.import('export/lys_tri_goodvibes.h5','supercell','I');
...
MTp.export('export/lys_tri_goodvibes_delta_pdf.h5','delta_pdf',P,'Datatype','single','ChunkSize',chunksize);
