...
[MT,rho] = proc.script.MapTools.import('export/lys_tri_edens_interp.h5','unwrapped_cropped','rho');
...
MTsim.export('export/lys_tri_goodvibes.h5','supercell',I,'Datatype','single','ChunkSize',chunksize);
