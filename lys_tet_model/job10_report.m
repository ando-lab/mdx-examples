...
reportDir = 'report';
reportFileName = 'report_lys_tet_model.md';
mkdir(reportDir)

%%
% initialize markdown file

report_md = {'# Report: tetragonal lysozyme modeling',datestr(now)};
...
imagesc(cell2mat(reshape(m,25,[])),[0,10*std(I(~isnan(I)))]);
set(gca,'Position',[0,0,1,1]);
axis image;axis off;colormap turbo

figName = 'reference_halos_lys_tet.png';
...
Ilatt = MT.read_data('export/lys_tet_goodvibes.h5','supercell','I');
...
figName = 'intensity_stats_lys_tet.png';
exportgraphics(fh,fullfile(reportDir,figName));
...
Tdb = readtable('export/lys_tet_goodvibes_com_covariances.csv');
...
figName = 'goodvibes_joint_adps_lys_tet.png';
exportgraphics(fh,fullfile(reportDir,figName));
...
Tdb = readtable('export/lys_tet_discoball_joint_adps.csv');
T = preprocess_covariance_table(Tdb);
...
figName = 'discoball_joint_adps_lys_tet.png';
exportgraphics(fh,fullfile(reportDir,figName));
...
Tdb = readtable('export/lys_tet_discoball_joint_adps.csv');
Tgv = readtable('export/lys_tet_goodvibes_joint_adps.csv');
...
figName = 'discoball_validation_lys_tet.png';
exportgraphics(fh,fullfile(reportDir,figName));
...
mapFileName = 'export/lys_tet_goodvibes_delta_pdf.h5';
...
mapFileName = '../lys_tet_map/export/lys_tet_delta_pdf.h5';
...
mapFileName = 'export/lys_tet_map_sub.h5';
...
mapFileName = 'export/lys_tet_goodvibes.h5';
