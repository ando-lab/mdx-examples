...
opts.mtzREFMAC =   'import/lys_1_refmac.mtz';
opts.mtzMerged =   'import/lys_1_Imerge.mtz';
opts.pdbFileName = 'import/lys_1_refmac.pdb';
...
x = 0.00005; % determined previously by fitting Fobs vs. Fcalc
